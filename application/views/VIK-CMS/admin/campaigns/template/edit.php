                ...
                <form role="form" method="POST">
                    <div class="col-lg-6">
                        <div class="form-group<?php echo is_error(validation_errors()); ?>">
                            <label>Name</label>
                            <input class="form-control" type="text" id="name" name="txtName" value="<?php echo set_value('txtName', $item['name']) ?>" placeholder="Please enter the name of template" />
                        </div>
                    ...
                    <div class="col-lg-6">                        
                        <div class="form-group">
                            ...
                            <div class="radio">
                                <label>
                                    <input type="radio" name="txtStatus" value="1" <?php echo set_radio('txtStatus', 1, (($item['status'] == 1) ? TRUE : FALSE)); ?>><span class="btn btn-success btn-xs">Active</span>
                                </label>
                            </div>
                            <div class="radio">
                                <label>
                                    <input type="radio" name="txtStatus" value="0" <?php echo set_radio('txtStatus', 0, (($item['status'] == 0) ? TRUE : FALSE)); ?>><span class="btn btn-danger btn-xs">Disable</span>
                                </label>
                            </div>
                        </div>
                    </div>
                    <div class="col-lg-12">
                        <div class="form-group">
                            <label>Content</label>
                            <textarea id="myeditor" class="form-control" name="txtContent" rows="12"><?php echo set_value('txtContent',$item['content']) ?></textarea>
