...
<head>
    ...
    <!-- Morris Charts CSS -->
    <link href="<?php echo base_url('public/admin/assets/vendor/morrisjs/morris.css') ?>" rel="stylesheet" />

    <!-- Custom Fonts -->
     <link href="<?php echo base_url('public/admin/assets/vendor/font-awesome/css/font-awesome.min.css') ?>" rel="stylesheet" />
